...
public class TripleSDES {
    ...
    public static void main(String args[]) {
        ...
        String rawkey1 = "1111111111";

        String rawkey2 = "1111111111";
        ...
        key1 = stringToInt(rawkey1);
        key2 = stringToInt(rawkey2);
        pt = stringToInt(input);

        int[] output = tripleDecrypt(pt,key1,key2);
    ...
    public static int[] tripleEncrypt (int[] pt, int[] key1, int[] key2) {

        int[] cyphertext = new int[8];


        cyphertext = encrypt(key1, decrypt(key2,encrypt(key1,pt)));

        return cyphertext;
    }

    public static int[] tripleDecrypt (int[] pt, int[] key1, int[] key2) {

        int[] cyphertext = new int[8];


        cyphertext = decrypt(key1, encrypt(key2,decrypt(key1,pt)));
    ...
    public static int[] encrypt(int[] key,int[] pt)
    {
        ...
        K1 = permutationP8(leftshiftLS1(permutationP10(key)));
        print(K1);

        K2 = permutationP8(leftshiftLS2(leftshiftLS1(permutationP10(key))));
    ...
    public static int[] decrypt( int[] key, int[] pt )
    {
        ...
        K2 = permutationP8(leftshiftLS1(permutationP10(key)));
        print(K2);

        K1 = permutationP8(leftshiftLS2(leftshiftLS1(permutationP10(key))));
        print(K1);
    ...
    public static int[] mappingF(int[] R, int[] SK)
    {
        ...
        int row1 = BinaryOp2.BinToDec(d11,d14); // for input in s-box S0


        int d12 = temp[1]; // second bit of first half
        int d13 = temp[2]; // third bit of first half
        int col1 = BinaryOp2.BinToDec(d12,d13); // for input in s-box S0


        int o1 = S0[row1][col1];

        int[] out1 = BinaryOp2.DecToBinArr(o1);
        ...
        int row2 = BinaryOp2.BinToDec(d21,d24);

        int d22 = temp[5]; // second bit of second half
        int d23 = temp[6]; // third bit of second half
        int col2 = BinaryOp2.BinToDec(d22,d23);

        int o2 = S1[row2][col2];

        int[] out2 = BinaryOp2.DecToBinArr(o2);
